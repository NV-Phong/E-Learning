...
export default function BookingContent() {
   ...
   // Memoize the fetchTeacher function to prevent unnecessary re-renders
               ...
               <CardContent className="p-6">
                  {selectedTeacher ? (
                     <div className="mb-6 p-4 bg-accent/10 rounded-lg">
                        <div className="flex items-center space-x-4">
                           <Avatar className="w-12 h-12">
                              <AvatarImage
                                 src={`/placeholder.jpg?key=drm8w&height=96&width=96&text=${encodeURIComponent(
                     ...
                     <p className="text-red-500 mb-6">
                        Vui lòng chọn giáo viên để tiếp tục.
                     </p>
                  )}
                     ...
                     <div>
                        <Label htmlFor="goals" className="text-foreground">
                           ...
                           <span className="text-sm text-muted-foreground ml-2">
                              ({formData.goals.length}/500 ký tự)
                           </span>
                        </Label>
                        <Textarea
                           id="goals"
                           ...
                           className={`${
                              errors.goals ? "border-red-500" : "border-border"
                           }`}
