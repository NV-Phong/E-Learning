      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Chào mừng bạn trở lại, {profileData.fullname}!</p>
          </div>
        ...
        <Tabs defaultValue="schedule" className="space-y-6">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                <Card className="bg-card border-border">
                  <CardHeader>
                    <CardTitle className="text-foreground">Lịch học sắp tới</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Calendar
                      mode="single"
              ...
              <div>
                <Card className="bg-card border-border">
                  <CardHeader>
                    <CardTitle className="text-foreground">Buổi học hôm nay</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <TabsContent value="packages">
            <Card className="bg-card border-border">
              <CardHeader>
                <CardTitle className="text-foreground">Gói học của tôi</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 border border-border rounded-lg">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <h3 className="font-semibold text-foreground">Gói Phổ Biến</h3>
                        <p className="text-sm text-muted-foreground">10 buổi học 1-1</p>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-foreground">3/10 buổi</span>
                      </div>
                      <Progress value={30} className="h-2" />
                    </div>
                    <div className="mt-3 text-sm text-muted-foreground">Hết hạn: 30/06/2024</div>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        id="fullname"
                        className={`bg-background ${errors.fullname ? "border-red-500" : "border-border"}`}
                    ...
                    <div>
                      ...
                      <Input
                        id="email"
                        type="email"
                        className={`bg-background ${errors.email ? "border-red-500" : "border-border"}`}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={`bg-background ${errors.phone ? "border-red-500" : "border-border"}`}
                  ...
                  <div>
                    ...
                    <Select value={profileData.level} onValueChange={(value) => handleProfileChange("level", value)}>
                      <SelectTrigger className={`bg-background ${errors.level ? "border-red-500" : "border-border"}`}>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
